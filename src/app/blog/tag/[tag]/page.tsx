...
export const metadata: Metadata = {
  title: 'Tag Archive | AMIR KNOWS PHUKET',
  description: 'Browse articles by tag on Phuket real estate.',
};
...
export default async function TagPage({ params }: { params: Promise<{ tag: string }> }) {
  ...
  // Note: serverFetchBlogs takes (category, tag)
  const blogs = await serverFetchBlogs(undefined, decodedTag);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4">
            ...
            <p className="font-desc-mona text-[16px] font-normal text-[#6B7280] max-w-2xl mx-auto leading-[1.5]">
              Articles and insights tagged with "{decodedTag}".
            </p>
          </div>
        </div>
      </section>
