...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Everything a foreign buyer needs to know: ownership structures, the buying process, taxes, and due diligence.',
    type: 'article',
  },
};

export default function TheGuideLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
