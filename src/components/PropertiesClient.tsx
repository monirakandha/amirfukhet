      ...
      <section className="pt-16 pb-8 flex-grow bg-white">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-6 border-b border-gray-100">
          <div className="space-y-1">
            ...
            <p className="text-[13px] text-gray-500">Refine properties by location and ownership.</p>
          </div>

          <div className="flex flex-wrap items-center gap-4 sm:gap-6">
            {/* Area */}
            <div className="flex flex-col space-y-1.5">
              <label className="text-[11px] font-bold text-gray-500 block uppercase tracking-wider ml-1">Select Area</label>
              <div className="relative">
                <select
                  value={areaFilter}
                  onChange={(e) => setAreaFilter(e.target.value)}
                  className="appearance-none bg-white border border-gray-200 hover:border-gray-300 rounded-xl pl-4 pr-10 py-2.5 text-[14px] text-gray-900 font-medium focus:outline-none focus:border-[#5870F7] focus:ring-1 focus:ring-[#5870F7] transition-all min-w-[160px] shadow-xs cursor-pointer"
                >
            ...
            {/* Tenure */}
            <div className="flex flex-col space-y-1.5">
              <label className="text-[11px] font-bold text-gray-500 block uppercase tracking-wider ml-1">Freehold / Leasehold</label>
              <div className="relative">
                <select
                  value={tenureFilter}
