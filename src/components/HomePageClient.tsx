  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col font-sans">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 items-start">
            ...
            <div className="flex flex-col gap-6 sm:gap-8">
              <Link href="/blog" className="group bg-white rounded-[24px] p-6 sm:p-7 transition-all duration-300 border border-white shadow-xs hover:bg-[#5870F7] hover:border-[#5870F7] hover:shadow-xl hover:-translate-y-1 flex items-start gap-5">
              ...
              <Link href="/blog" className="group bg-white rounded-[24px] p-6 sm:p-8 transition-all duration-300 border border-white shadow-xs hover:bg-[#5870F7] hover:border-[#5870F7] hover:shadow-xl hover:-translate-y-1 flex flex-col justify-between">
                <div>
      ...
      <section className="py-20 md:py-24 bg-white border-t border-gray-100 font-sans">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className="rounded-[32px] p-8 md:p-14 lg:p-16 border border-gray-800/60 relative overflow-hidden bg-[#1C2026]"
            style={{
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center relative z-10">
              ...
              <div className="lg:col-span-5">
                <div className="max-w-[460px] w-full lg:ml-auto">
                  <form
                    onSubmit={async (e) => {
                      e.preventDefault();
                  ...
                  >
                    <div>
                      <label className="font-desc-mona text-[14px] font-medium text-gray-200 block mb-2 leading-none">Name</label>
                      <input type="text" required placeholder="Enter your name" className="font-desc-mona text-[15px] font-normal text-white placeholder-gray-500 leading-none w-full bg-[#2A2D33] border border-gray-600/50 rounded-[16px] px-5 py-3.5 focus:outline-none focus:border-[#5870F7] transition-colors" />
                    </div>
                    <div>
                      <label className="font-desc-mona text-[14px] font-medium text-gray-200 block mb-2 leading-none">Email</label>
                      <input type="email" required placeholder="Enter your email" className="font-desc-mona text-[15px] font-normal text-white placeholder-gray-500 leading-none w-full bg-[#2A2D33] border border-gray-600/50 rounded-[16px] px-5 py-3.5 focus:outline-none focus:border-[#5870F7] transition-colors" />
                    </div>
                    <div>
                      <label className="font-desc-mona text-[14px] font-medium text-gray-200 block mb-2 leading-none">Phone Number</label>
