...
const defaultSettings: SiteSettings = {
  ...
  pagesContent: {
    ...
    aboutPage: {
      ...
      stat1Value: '7+ yrs',
      stat1Label: 'In the Phuket market',
      stat2Value: '50+',
      stat2Label: 'Foreign buyers guided',
      stat3Value: '12',
      stat3Label: 'Nationalities served',
      storyHeadline: 'My story',
      storyDescription: 'Placeholder biography. The published page tells how Amir came to Phuket, the years spent learning the market from the inside, and why he chose to work as an independent advisor rather than an agent.',
      approachHeadline: 'My approach & philosophy',
      approachDescription: 'Advisory, not transactional. Honest about risk. Foreigner-focused. The goal is a client who refers their friends – not a quick commission.',
      calloutHeadline: 'Want to work together?',
      calloutSubheading: 'Start with a free, no-pressure conversation.',
      calloutButtonText: 'Ask Amir',
      calloutButtonLink: 'https://wa.me/8801875189361',
      calloutImage: '/images/amir.png',
    },
    workWithMePage: {
      ...
      advisorCard1Title: 'Independent',
      advisorCard1Desc: 'I\'m paid to advise you well, not to push one developer\'s stock. You hear the downsides too.',
      advisorCard2Title: 'Due-diligence first',
      advisorCard2Desc: 'Title checks, developer track record, lease terms — the unglamorous work that protects your money.',
      advisorCard3Title: 'On the ground',
      advisorCard3Desc: 'Based in Phuket. I view the property, meet the people, and represent your interests locally.',
      ...
      confidenceItem1: 'A clear read on your goals – lifestyle, yield, or both',
      confidenceItem2: 'A shortlist of properties that genuinely fit, with the trade-offs spelled out',
      confidenceItem3: 'Due diligence on title, developer and ownership structure',
      confidenceItem4: 'Guidance through negotiation, contracts and transfer',
      confidenceItem5: 'Introductions to vetted lawyers, and rental management if you need it',
      confidenceButtonText: 'Ask Amir',
      confidenceButtonLink: 'https://wa.me/8801875189361',
      processSectionPill: 'How to get started',
      processSectionHeadline: 'A simple, no-pressure process',
      processStep1Title: 'Reach out',
      processStep1Desc: 'A message on WhatsApp or the form. Tell me what you\'re considering.',
      processStep2Title: 'Free consultation',
      processStep2Desc: 'We talk through goals, budget and areas. No obligation.',
      processStep3Title: 'Research & shortlist',
      processStep3Desc: 'I do the legwork and bring you properties that actually fit.',
      processStep4Title: 'Buy with confidence',
      processStep4Desc: 'Due diligence, negotiation and transfer – I\'m with you throughout.',
      ctaHeadline: 'Let\'s talk about your purchase',
      ctaDescription: 'The first conversation is free, and there\'s no pressure to go further.',
      ctaButton1Text: 'WhatsApp Amir',
      ctaButton1Link: 'https://wa.me/8801875189361',
      ctaButton2Text: 'Book a consultation',
      ctaButton2Link: '#contact-form',
    },
    contactPage: {
      heroPill: 'Contact Us',
      heroHeadline: 'Get in touch with Amir',
      heroDescription: 'A straight, honest reply – usually within 24 hours. No sales pitch.',
      fastestWaysHeadline: 'Fastest ways to reach me',
      whatsappCardTitle: 'WhatsApp',
      whatsappCardDesc: 'Message or call directly',
      emailCardTitle: 'amir@amirknowsphuket.com',
      emailCardDesc: 'Email Amir directly',
